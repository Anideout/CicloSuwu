...
def obtener_estadisticas():
    ...
    for i in range(len(productos)):
        if precios[x] <= valor_grande:
            valor_grande = precios[x]
            ind_gran = i
        else:
            None
    print(f"EL producto con el precio más alto es {productos[ind_gran]} y su precio es de ${mayor_precio}")
