...
#     #se declara inicio de archivo
#     with_open('Reporte_estudiantes.csv', mode = 'w', newline= '') as file:
#         writer = csv.writer(file)
#         #crear la cabecera del coumento
#         writer.writerow(["ID","NOMBRE", "EDAD", "NOTA", "ASISTENCIA", "CONDUCTA"])
#         #pintar el documento
#         for estudiante in estudiantes:
...
def descargar_archivo():
        ...
        with open('Reporte_estudiantes.csv', mode='w', newline='') as file:
            ...
            for estudiante in estudiantes:
                writer.writerow(estudiante)
        print("archivo 'eporte_estudiantes.csv' creado exitosamente!")